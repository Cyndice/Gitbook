...
/*pre {
   border-radius: 200px;  设置圆角半径 
  background-color: #F7F9FA;  设置背景色 
 box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2); 添加阴影 
}*/
body {
  background-image: url('./handbook_readme.jpg') !important;
...
#tutorial-tip-box {
    ...
    padding: 15px 20px; /* **恢复上下内边距为15px，左右20px** */
    border-radius: 8px; /* 更小的边角弧度 */
    box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); /* 阴影更小更柔和 */
    z-index: 9999; /* 确保在遮罩层之上 */
    display: none; /* 默认隐藏 */
    text-align: center;
    color: #333;
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    animation: fadeIn 0.4s ease-out forwards; /* 动画速度稍微加快 */
    transform: translateY(8px); /* 初始稍微下移，幅度减小 */
    opacity: 0; /* 初始透明 */
}
...
#tutorial-tip-box p {
    margin-bottom: 10px; /* **恢复段落底部外边距为10px** */
    font-size: 1em; /* 提示文字字体缩小到 1em */
    font-weight: 500; /* 字体不那么粗 */
    color: #2c3e50;
}

#tutorial-tip-box button {
    background-color: #4CAF50; /* 绿色按钮 */
    color: white;
    border: none;
    padding: 8px 15px; /* 缩小按钮大小 */
    border-radius: 4px; /* 按钮边角更小 */
    cursor: pointer;
    font-size: 0.85em; /* 缩小按钮文字字体 */
    font-weight: 500;
    transition: background-color 0.2s ease, transform 0.1s ease;
}

#tutorial-tip-box button:hover {
    background-color: #45a049;
    transform: translateY(-0.5px); /* 悬停时轻微上浮 */
}
...
.highlight-navbar {
    ...
    border: 2px solid #4CAF50 !important; /* 添加一个绿色边框，使其更明显 */
    border-radius: 8px !important; /* 让边框圆润 */
    box-shadow: 0 0 10px rgba(76, 175, 80, 0.6) !important; /* 绿色阴影效果 */
    transition: all 0.3s ease-in-out !important; /* 添加过渡效果，让高亮更平滑 */
}